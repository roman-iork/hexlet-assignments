...
class AppTest {
    ...
    // BEGIN
    @Test
    void testReversedSequenceMethods() {
        ReversedSequence text = new ReversedSequence("shelf");
        String expected1 = "flehs";
        String actual1 = text.toString();
        assertThat(actual1).isEqualTo(expected1);
        int expected2 = 5;
        int actual2 = text.length();
        assertThat(actual2).isEqualTo(expected2);
        char expected3 = 's';
        char actual3 = text.charAt(4);
        assertThat(actual3).isEqualTo(expected3);
        String expected4 = "hs";
        String actual4 = text.subSequence(3, 5).toString();
